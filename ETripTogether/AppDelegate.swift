...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        // MARK: Google Places
        GMSServices.provideAPIKey("AIzaSyAUwHCdY9e49YuDKrpXgH2jaIBBnES8BKY")
        GMSPlacesClient.provideAPIKey("AIzaSyAUwHCdY9e49YuDKrpXgH2jaIBBnES8BKY")
...
//        Fabric.with([Crashlytics.self])
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "erinshih.ETrip" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("ETrip", withExtension: "momd")!
